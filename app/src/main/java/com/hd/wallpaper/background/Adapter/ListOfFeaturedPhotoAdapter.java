...
public class ListOfFeaturedPhotoAdapter extends RecyclerView.Adapter<ListOfFeaturedPhotoAdapter.MyViewHolder>
{
    ...
    public ListOfFeaturedPhotoAdapter(Context context, List<FeaturedPhotos> featuredPhotosList, ListOfFeaturedPhotoAdapter.photoClick photoClick) {
        this.context = context;
        this.featuredPhotosList = featuredPhotosList;
    ...
    {
        final FeaturedPhotos featuredPhoto = featuredPhotosList.get(holder.getAdapterPosition());

        DisplayMetrics displaymetrics = WallpaperApplication.getInstance().getResources().getDisplayMetrics();

        float finalHeight = displaymetrics.widthPixels / (Float.parseFloat(featuredPhoto.getWidth())/Float.parseFloat(featuredPhoto.getHeight()));
        ...
        Glide.with(context)
//                .asBitmap()
                .load(featuredPhoto.getUrls().getRegular())
...
//                .waitForLayout();
        ...
        holder.txt_username.setText(featuredPhoto.getUser().getName());
        ...
        holder.img_photo.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(photoClick!=null)
                {
                    photoClick.onPhotoClick(holder.getAdapterPosition(),featuredPhoto.getId(),holder.img_photo.getDrawable());
                }
            }
        });
    }
    ...
    {
        return featuredPhotosList.size();
    }
